...
export const MenuList = [
  ...
  },
  {
    ...
    image: Hamburger,
    description:
      "A mouthwatering fusion of succulent ground beef infused with aromatic Italian herbs and spices.",
  },
  {
    name: "Chocolate Cake",
    image: Cake,
    description:
      "Generously sandwiched between luscious chocolate ganache, creating a symphony of intense cocoa flavors.",
  },
  {
    name: "Tin Roof Ice",
    image: IceCream,
    description:
      " A timeless treat that marries velvety vanilla ice cream with swirls of fudgy chocolate and roasted peanuts.",
  },
  {
    name: "Lasagna",
    image: Lasagna,
    description:
      " A flat and expanded pasta sheet, traditionally made in Italy with Parmigiano-Reggiano (Parmesan cheese), and ragù (a meat-based sauce).",
  },
  {
    name: "Greek Salad",
    image: Greek,
    description:
      " Greek salad is made with pieces of tomatoes, sliced cucumbers, onion, feta cheese, and olives, typically seasoned with salt and Greek mountain oregano, and dressed with olive oil.",
  },
  {
    name: "Strawberrry cheesecake",
    image: cheesecake,
    description:
